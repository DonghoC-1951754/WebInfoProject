...
function LoginForm() {
  return (
    <div class="font-[sans-serif] bg-gray-50 dark:bg-gray-900 text-white">
      <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            ...
            <p class="text-sm mt-6 ">DOE WERK VINDEN </p>
            <p class="text-sm mt-12 ">
              Don't have an account{" "}
              <Link to={"/registration"} class="text-blue-600 font-semibold hover:underline ml-1">
                Register here
              </Link>
            </p>
          </div>
          ...
          <form class="max-w-md md:ml-auto w-full">
            <h3 class=" text-3xl font-extrabold mb-8">Sign in</h3>
            <div class="space-y-4">
              <div>
                <input
                  name="email"
                  ...
                  autocomplete="email"
                  required
                  class="bg-gray-100 w-full text-sm  px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent"
